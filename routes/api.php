...
Route::prefix('public')->name('api.public.')->group(function () {
    ...
    Route::post('/actividades/{actividad}/asistencias/dni', [\App\Http\Controllers\Actividad\ActividadSujetoController::class, 'marcarAsistenciaDNI'])
        ->middleware('throttle:10,1')
        ->name('actividades.asistencia.dni');
});
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // ── Personas module ───────────────────────────────────────────────────────
    Route::get('personas/export', [App\Http\Controllers\Sector\PersonaController::class, 'export'])
        ->middleware('permission:personas:view')
        ->name('api.personas.export');
